...
extension UIKitBridge {
  struct SwiftUITextView: View {
    ...
    var body: some View {
      SwiftUITextViewInner(title, text: $text, height: $height, isFirstResponder: isFirstResponder, onEditingChanged: onEditingChanged, onCommit: onCommit)
        .frame(height: height)
    }
  }

  private struct SwiftUITextViewInner: UIViewRepresentable {
    @Binding var text: String
    ...
    func makeUIView(context: UIViewRepresentableContext<SwiftUITextViewInner>) -> UITextView {
    ...
    func updateUIView(_ uiView: UITextView, context: UIViewRepresentableContext<SwiftUITextViewInner>) {
    ...
    class Coordinator: NSObject, UITextViewDelegate {
      var parent: SwiftUITextViewInner

      init(_ autoFocusTextView: SwiftUITextViewInner) {
