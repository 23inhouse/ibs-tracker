...
struct MedicationRowView_Previews: PreviewProvider {
  static var previews: some View {
    ScrollView {
      MedicationRowView(for: IBSRecord(medication: "Perenterol", type: .probiotics, timestamp: Date(), tags: ["Perenerol"]))
      MedicationRowView(for: IBSRecord(medication: "Perenterol Enema", type: .probiotics, timestamp: Date(), tags: ["Pereneterol"]))
